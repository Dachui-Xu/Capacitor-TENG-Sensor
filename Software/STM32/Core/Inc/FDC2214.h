...
// FDC2214 Device Address，ADDR:0->0x2A,ADDR:1->0x2B
#define FDC2214_Addr                 (0x2A)
// FDC2214 Register address definition
...
typedef struct {
		uint32_t values[CAP_CHANNEL_NUM];
    double capacitances[CAP_CHANNEL_NUM];
} Cap_Data_t;


/* FDC2214 task function */
